# Spring AI Alibaba Video Examples

## 模块定位

这个聚合模块当前包含 DashScope 视频示例，用于统一管理文生视频、图生视频、视频编辑和相关模型接口示例。
...
```bash
mvn -f spring-ai-alibaba-video-example/pom.xml test-compile -DskipTests
