# Workflow-Review-Classifier 模块

## 模块说明

本模块是 workflow-review-classifier 模块，包含 1 个控制器。

## 接口文档

### GraphRunController 接口
...
**示例请求：**
```bash
GET http://localhost:8080/invoke
```
...
### 使用 HTTP 文件测试
模块根目录下提供了 **[workflow-review-classifier.http](./workflow-review-classifier.http)** 文件，包含所有接口的测试用例：
- 可在 IDE 中直接执行
- 支持参数自定义
- 提供默认示例参数
...
*此 README.md 由自动化工具生成于 2025-12-09 23:31:12*
