 ...
 *
 * REST controller for streaming graph processing operations. Provides Server-Sent Events
 * (SSE) streaming output interface.
 *
 * Features: - Real-time streaming output - SSE protocol support - Configurable thread
