...
- 启动入口：ReflectionApplication
- Web 入口：ReflectionController
...
```bash
mvn -f spring-ai-alibaba-graph-example/reflection/pom.xml test-compile -DskipTests
mvn -f spring-ai-alibaba-graph-example/reflection/pom.xml spring-boot:run
```
