...
本模块是 reflection 模块，包含 1 个控制器。

## 接口文档

### ReflectionController 接口

#### 1. simpleChat 方法

**接口路径：** `GET /reflection/chat`
...
**示例请求：**
```bash
GET http://localhost:8080/reflection/chat
```
...
### 使用 HTTP 文件测试
模块根目录下提供了 **[reflection.http](./reflection.http)** 文件，包含所有接口的测试用例：
- 可在 IDE 中直接执行
- 支持参数自定义
- 提供默认示例参数
...
```bash
# simpleChat 接口测试
curl "http://localhost:8080/reflection/chat"
```
...
*此 README.md 由自动化工具生成于 2025-12-09 23:30:47*
